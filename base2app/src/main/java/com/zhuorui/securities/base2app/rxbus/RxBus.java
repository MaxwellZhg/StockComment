...
/**
 * 注意： 需要订阅的方法必须是public类型
 * 如 @RxSubscribe(observeOnThread = EventThread.MAIN)
 * fun onLogin(response: BaseResponse) {
 * }
...
//    /**
//     * Get the activity-scope RxBus instance
//     */
//    public static RxBus getDefault(Activity activity) {
//        if (activity == null) {
//            LoggerUtil.error("Can't find the Activity, the Activity is null!");
//            return getDefault();
//        }
//        AppActivityLifecycleImp appActivityLifecycleImp = BaseApplication.Companion.getBaseApplication().getAppActivityLifecycleImp();
//        if (appActivityLifecycleImp != null) {
//            LazyRxBus lazyRxBus = appActivityLifecycleImp.getActivityRxBusScopePool().get(activity);
//            if (lazyRxBus == null) {
//                LoggerUtil.error( "Can't find the Activity, it has been removed!");
//                return getDefault();
//            }
//            LoggerUtil.debug( "Find the Activity successful, return lazyRxBus");
//            return lazyRxBus.getRxBus();
//        }
//        return getDefault();
//    }
        ...
        Observable.just(subscriber)
                ...
                .flatMap(new Function<Object, ObservableSource<Method>>() {
                    ...
                    public ObservableSource<Method> apply(Object obj) throws Exception {
                        ...
                        return Observable.fromArray(obj.getClass().getMethods());
                    }
                })
                ...
                .subscribe(
                        new Consumer<Object>() {
                            ...
                            public void accept(Object obj) throws Exception {
                                ...
                                if (obj.getClass() != parameterType) return;
