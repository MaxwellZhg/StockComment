...
import com.zhuorui.securities.applib5.BR;
...
public class FragmentMyBindingImpl extends FragmentMyBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((com.zhuorui.securities.applib5.ui.viewmodel.MyTabViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable com.zhuorui.securities.applib5.ui.viewmodel.MyTabViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeViewmodel((com.zhuorui.securities.applib5.ui.viewmodel.MyTabViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewmodel(com.zhuorui.securities.applib5.ui.viewmodel.MyTabViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        com.zhuorui.securities.applib5.ui.viewmodel.MyTabViewModel viewmodel = mViewmodel;
